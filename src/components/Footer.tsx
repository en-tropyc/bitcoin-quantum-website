    ...
    <footer className="border-t border-[rgba(0,240,255,0.1)] py-8 mt-10 relative z-10">
      <div className="max-w-[1100px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-5">
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/btq-ag/btq-core" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[#00f0ff] transition-colors" aria-label="GitHub">
          ...
          <a href="https://x.com/btc_quantum" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[#00f0ff] transition-colors" aria-label="Twitter">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
