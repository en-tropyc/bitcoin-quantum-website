  ...
  return (
    <div className="min-h-screen bg-[#0B1426] flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Development Roadmap Section - Full Width */}
        ...
        {/* Releases and Developer Notes Section - Two Columns */}
        <div className="py-16 bg-[#0B1426]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              
              {/* Releases Section - Left Column */}
              <div>
                <div className="mb-6">
              ...
              {/* Developer Notes Section - Right Column */}
              <div>
                <div className="mb-6">
