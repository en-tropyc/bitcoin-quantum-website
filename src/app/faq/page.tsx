...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Bitcoin Core's security model, hardened with NIST FIPS 204 signatures. Spends are cryptographically secure against both classical and quantum attacks. To report a security issue, email security@btq.com — please don't open a public GitHub issue for vulnerabilities.",
  },
  {
    id: 7,
    category: 'technical',
